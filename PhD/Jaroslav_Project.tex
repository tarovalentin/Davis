...
\begin{figure}[H]\centering \hspace*{3cm}
	...
	\end{tikzpicture}
\end{figure}
While the $C$-matrix is found through
\begin{equation}
	\begin{aligned}
...
One can build all the physically relevant on-shell diagrams by attaching BCFW bridges to existing
...
\begin{equation}
	...
	\end{aligned}
\end{equation}
Let us further examine the six-point NMHV case by looking at an example of a 4+4 diagram. It is not possible to orient the graph with an closed cycle for the external helicity configuration of $(1^+,2^-,3^+,4^-,5^+,6^-)$, so instead we consider the following diagram
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{6pt}
	\caption{}
	\label{fig:two-loop}
\end{figure}
The $C$-matrices are
\begin{equation}
	...
	\end{aligned}
\end{equation}
The edge-variables are found to be
\begin{align*}
 \alpha_1 = \frac{[23]}{[13]}\,, \quad \alpha_2 =- \frac{[12]}{[23]}&\,,~~
...
\begin{equation}
	\begin{aligned}
		J_a=\delta_a^{-1}=\frac{\aMs{4}{Q_{456}}{1}\aMs{6}{Q_{456}}{3}}{\aMs{4}{Q_{456}}{3}\aMs{6}{Q_{456}}{1}}
	\end{aligned}
\end{equation}
Using the aforementioned we can also infer the Jacobian of the diagram with the internal cycle reversed
\begin{equation}
	\begin{aligned}
		J_b=\frac{\aMs{4}{Q_{456}}{1}\aMs{6}{Q_{456}}{3}}{[13]\ab{46}s_{456}}
	\end{aligned}
\end{equation}
The form obtained
is then
\begin{equation}
	\begin{aligned}
		...
		\left[\frac{\aMs{4}{Q_{456}}{1}\aMs{6}{Q_{456}}{3}}{\aMs{4}{Q_{456}}{3}\aMs{6}{Q_{456}}{1}}\right]^{-4}+\left[\frac{\aMs{4}{Q_{456}}{1}\aMs{6}{Q_{456}}{3}}{[13]\ab{46}s_{456}}\right]^{-4}
		\right)	
	\end{aligned}
\end{equation}
...
First we assign the three loop momenta $\ell_1,\ell_2$, and $\ell_3$, in the following way
\begin{figure}[H]
	\centering
...
\begin{equation}
	\begin{aligned}
	\ell_1=\frac{\tilde\lambda_4}{\ab{46}}\aMs{6}{Q_{456}}{\bm\cdot},~~~~~~\ell_2=\frac{1}{\aMs{6 }{Q_{456}}{1}}\aMs{3 }{Q_{456}}{\bm\cdot}\aMs{\bm \cdot }{Q_{456}}{4},~~~~~~	\ell_3=\frac{\tilde\lambda_3}{\sqb{13}}\aMs{\bm\cdot}{Q_{456}}{1}\\
	\ell_1+4=\frac{\ab{56}}{\ab{46}}\lambda_4\tilde{\lambda}_5
	\end{aligned}
\end{equation}
\newpage
