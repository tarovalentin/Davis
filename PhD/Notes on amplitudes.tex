...
\begin{equation}
	...
	\end{aligned}
\end{equation}
and a Jacobian of $\frac{1}{\expval{15}^2\expval{13}}$. For this diagram we have two negative helicity particles $1$ and $5$ which is seen from the incoming arrows.
